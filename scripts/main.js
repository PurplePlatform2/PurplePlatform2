//const LightweightCharts = require('lightweight-charts'); // External dependency
...
(function() {
    ...
    xAuth = new WebSocket("wss://ws.derivws.com/websockets/v3?app_id=1089");
    let loadingInterval;
    ...
    class TradingChart {
        ...
        #socket; #chart; #candleSeries; #indicatorSeries; #ghostSeries; #symbol;
        #loaderElement; #chartElement; #ghostCandle = null; #data = []; 
        #indicatorData = []; #earliestTime = Math.floor(Date.now() / 1000);
        #isLoading = false; #isHistoryFullyLoaded = false; 
        #rangeDebounceTimer = null; #subscriptionId = null; #currentTheme = 'dark';
